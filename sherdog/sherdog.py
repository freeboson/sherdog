...
class Sherdog:
    ...
    def find(self, fighter_id, json_format=True):
        ...
        req = urllib2.Request(url=fighter_url, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36'})
